...
export default class MainMenu {
    ...
    AddButtons() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            this.buttons[i].y = i * 100 + 300// window.app.screen.height - window.app.screen.height / 10 - (i * window.app.screen.height / 10 + 20);
            this.buttons[i].width = window.app.screen.width / 4;
            this.buttons[i].height = window.app.screen.height / 11;
            this.buttons[i].x = screen.width / 2 - this.buttons[i].width / 2
